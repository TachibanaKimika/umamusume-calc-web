        ...
        <div class="cardbox" v-for="i in 4">
            ...
            <div class="table">
                <table class="content-table" v-if="selected_card[i-1]">
                    ...
                    <tr v-if="selected_card[i-1].spc_tokuitu>0">
                        <td>得意率</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_tokuitu}}%</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_youujo>0">
                        <td>友情ボーナス</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_youujo}}%</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_yaruki>0">
                        <td>やる気効果</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_yaruki}}%</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_tore>0">
                        <td>トレーニング効果</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_tore}}%</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_hit_lv>0">
                        <td >ヒントLv</td>
                        <td v-if="selected_card[i-1]">LV{{selected_card[i-1].spc_hit_lv}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_hit_ritu>0">
                        <td>ヒント発生率</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_hit_ritu}}%</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_kizuna>0">
                        <td>初期絆ゲージ</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_kizuna}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_race>0">
                        <td>レースボーナス</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_race}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_reduce_suta>0">
                        <td>体力消費ダウン</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_reduce_suta}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_reduce_shipai>0">
                        <td>失敗率ダウン</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_reduce_shipai}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_jiken_up>0">
                        <td>イベント効果</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_jiken_up}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_jiken_kaifuku_up>0">
                        <td>イベント回復量</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_jiken_kaifuku_up}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-if="selected_card[i-1].spc_kashi_kaifuku>0">
                        <td>賢さ友情回復量</td>
                        <td v-if="selected_card[i-1]">{{selected_card[i-1].spc_kashi_kaifuku}}</td>
                        <td v-else>N/A</td>
                    </tr>
                    <tr v-for="j in 5" v-if="selected_card[i-1].spc_init_stu[j-1]>0">
                        <td>初期{{getAttribute(j,'bonasu')}}提升</td>
                    ...
                    <tr v-if="selected_card[i-1].spc_result.awareritu>0">
                        <td>得意练习出现率</td>
