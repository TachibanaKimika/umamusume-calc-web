 ...
 * @LastEditTime: 2021-09-03 00:43:51
...
var initChartsOption_Pie = function (cardAtbCountArray) {
    let option = {
        title: {
            text: "支援卡属性统计(不包含R卡)",
            textStyle: {
        ...
        series: [{
            ...
            data: [{
                    value: cardAtbCountArray[0],
                    name: 'スビート'
                },
                {
                    value: cardAtbCountArray[1],
                    name: 'スタミナ'
                },
                {
                    value: cardAtbCountArray[2],
                    name: 'パワー'
                },
                {
                    value: cardAtbCountArray[3],
                    name: '根性'
                },
                {
                    value: cardAtbCountArray[4],
                    name: '賢さ'
                },
                {
                    value: cardAtbCountArray[5],
                    name: '友人'
                }
            ]
        }]
...
var initChartsOption_scatter = function (numArray, type) {
    let option = {
        tooltip: {
            position: 'top'
        },
